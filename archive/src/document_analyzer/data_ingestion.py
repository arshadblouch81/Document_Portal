...
if __name__ == "__main__":
    ...
    pdf_path=r"D:\\LLMOPS Industry Projects\\document_portal\\data\\NIPS-2017-attention-is-all-you-need-Paper.pdf"
    class DummnyFile:
    ...
    directory = "D:/LLMOPS Industry Projects/document_portal/data"
    files = [
